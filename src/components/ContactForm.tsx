  ...
  return (
    <form onSubmit={handleSubmit} className="mt-4 space-y-3 text-sm" noValidate>
      ...
      <button
        ...
        className="mt-2 inline-flex w-full items-center justify-center rounded-full bg-amber-400 px-4 py-2 text-xs font-semibold text-slate-950 shadow-sm ring-1 ring-amber-300/70 transition hover:bg-amber-300 hover:ring-amber-200 disabled:cursor-not-allowed disabled:opacity-70"
      >
